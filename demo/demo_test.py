...
def generate_initial_data(n=28):
    train_x = draw_sobol_samples(bounds=bounds,n=1, q=n, seed=2023).squeeze(0)
    Mn, MWD_re, conv = KMC_multi(train_x)
...
def optimize_acqf_and_get_observation(acq_func):
    ...
    Mn, MWD_re, conv = KMC_multi(new_x)
...
train_x, train_obj, train_con1, train_con2 = generate_initial_data(n=28)
mll, model = initialize_model(train_x, train_obj, train_con1, train_con2)
