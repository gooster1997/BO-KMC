...
static void calc_a(int Xi1, int Xi2, int Xa, int Xb, long Xatol, long Xbtol, double c[], double a[], double conc, int V){
...
static PyObject *Monte_photo_coup(PyObject *self, PyObject *args){
...
static PyObject *Monte_photo_disp(PyObject *self, PyObject *args);
static PyObject *Monte_therm_disp(PyObject *self, PyObject *args);
static PyObject *Monte_therm_coup(PyObject *self, PyObject *args);
static PyMethodDef Monte_funcs[]={

    {"photo_coup", Monte_photo_coup, METH_VARARGS, "Mn and MWD"},
    {"photo_disp", Monte_photo_disp, METH_VARARGS, "Mn and MWD"},
    {"therm_coup", Monte_therm_coup, METH_VARARGS, "Mn and MWD"},
    {"therm_disp", Monte_therm_disp, METH_VARARGS, "Mn and MWD"},
    {NULL, NULL, 0, NULL}
};    
